...
class yCoreAutoloader extends yAutoloader{
    ...
    protected $_classes = array(
        ...
        'yEvent'=>'events/yEvent.php',
        'yEventDispatcher'=>'events/yEventDispatcher.php',
        ...
        'yJsCommentNode'=>'html/yJsCommentNode.php',
        'yLocalFileSystem'=>'file/yLocalFileSystem.php',
        'yMetaTag'=>'html/yMetaTag.php',
        'yMethodDocumentor'=>'doc/yMethodDocumentor.php',
        'yModelCollection'=>'model/query/yModelCollection.php',
        'yModelExpression'=>'model/query/yModelExpression.php',
        'yModelField'=>'model/query/yModelField.php',
        'yModelFunction'=>'model/query/yModelFunction.php',
        'yModelOrder'=>'model/query/yModelOrder.php',
        'yModelQuery'=>'model/query/yModelQuery.php',
        'yModelQueryParameter'=>'model/query/yModelQueryParameter.php',
        'yModelSql'=>'model/query/yModelSql.php',
        'yPage'=>'page/yPage.php',
        'yPageMetaCollection'=>'page/yPageMetaCollection.php',
        'yRegistry'=>'registry/yRegistry.php',
        'yRequest'=>'request/yRequest.php',
        'yStyleTag'=>'html/yStyleTag.php',
        'yTextInput'=>'forms/yTextInput.php',
        'yTextNode'=>'html/yTextNode.php',
        'yTrackingRegistry'=>'registry/yTrackingRegistry.php',
        'yUri'=>'uri/yUri.php',
